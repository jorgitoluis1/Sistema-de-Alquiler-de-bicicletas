...
import utpl.proyectos.bisicletas.entidades.Reservacion;
...
import utpl.proyectos.bisicletas.logica.ReservacionFacade;
...
public class ReservacionController implements Serializable {
    ...
    @EJB
    private utpl.proyectos.bisicletas.logica.ReservacionFacade ejbFacade;
