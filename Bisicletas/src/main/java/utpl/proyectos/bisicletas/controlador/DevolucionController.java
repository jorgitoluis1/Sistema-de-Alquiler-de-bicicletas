...
import utpl.proyectos.bisicletas.logica.DevolucionFacade;
...
@Named("devolucionController")
@SessionScoped
public class DevolucionController implements Serializable {

    @EJB
    private utpl.proyectos.bisicletas.logica.DevolucionFacade ejbFacade;
    ...
    public Devolucion getDevolucion(java.lang.Integer id) {
    ...
    public static class DevolucionControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getDevolucion(getKey(value));
        }
